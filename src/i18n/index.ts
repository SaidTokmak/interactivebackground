...
function localizeNativeError(
  ...
  const exact: Record<string, TranslationKey> = {
    ...
    "Widget boyutu hedef monitör için çok küçük.": "error.layout",
    "Monitör ölçüsü geçersiz.": "error.layout",
    "Widget yerleşimi sonlu sayılardan oluşmalıdır.": "error.layout",
    "Widget başka bir widget ile çakışamaz.": "error.layout",
    "Bu widget için yeterli boş alan bulunamadı.": "error.layout",
